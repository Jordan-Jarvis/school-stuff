...
*    Estimated:  0.0 hrs   
*    Actual:     0.0 hrs
*      This one was really easy.. I do this all the time in batch.
************************************************************************/
...
/*****************************************************
 * calculate if they are a full tithe payer
 * if not then return false, if so return true
 *****************************************************/
bool isFullTithePayer(float income, float tithe)
{
   return (tithe >= (income * 0.1));
}
