...
*      errors. I hated them and then realized why. it makes sense now.
************************************************************************/
...
/**********************************************************************
* Computes taxes based on the income from above
***********************************************************************/
...
* budgetLiving
***********************************************************************/
double getBudgetOther(double income,double expectedTithing,
   double budgetLiving, double monthlyTax)
{
   double budgetOther;
   budgetOther = (income - (expectedTithing + 
...
int main()
{
   ...
   double budgetOther = getBudgetOther(income,expectedTithing,
      budgetLiving,monthlyTax);
   ...
   display(income, actualLiving, budgetLiving, actualTax, 
      ...
      budgetOther, differenceActual, monthlyTax);
   return 0;
}
//end main
